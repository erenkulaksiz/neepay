        ...
        <View style={{ flex: 1, backgroundColor: "white" }}>
            ...
            <View style={{ flex: 1, justifyContent: "center", alignItems: "center", }}>
                <View style={{ position: "absolute", top: -100, }}>
                    <TouchableOpacity style={{ width: 166, height: 166, borderColor: "#DCDCDC", justifyContent: "center", alignItems: "center", borderRadius: 17, borderStyle: "solid", borderWidth: 1, backgroundColor: "white", elevation: 12 }}>
                    ...
                    <TouchableOpacity style={{ width: 166, height: 166, marginTop: 24, justifyContent: "center", alignItems: "center", borderColor: "#DCDCDC", borderRadius: 17, borderStyle: "solid", borderWidth: 1, backgroundColor: "white", elevation: 12 }}>
